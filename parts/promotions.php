...
$default_promos = array(
    array(
        ...
        'badge_color' => '#fff',
        'title'       => "Cartes de\nfidelite",
        'text'        => "Cumulez des avantages voyage et profitez d'offres reservees a nos clients fideles.",
        'style'       => 'blue',
        'url'         => '#',
    ),
    array(
        ...
        'badge_color' => '#f37a1f',
        'title'       => "Programme\nBztam e-Sfar",
        'text'        => "Accedez a des reductions exclusives et des services prioritaires sur vos prochaines reservations.",
        'style'       => 'orange',
        'url'         => '#',
    ),
    array(
