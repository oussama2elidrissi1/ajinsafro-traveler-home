    ...
    <div class="aj-container">
        ...
        <div class="aj-regions__grid">
            ...
            <a href="<?php echo esc_url($u); ?>" class="aj-reg">
                <?php if ($img) : ?><img loading="lazy" decoding="async" width="800" height="600" src="<?php echo esc_url($img); ?>" alt="<?php echo esc_attr($t); ?>" class="aj-reg__img"><?php else : ?><div class="aj-reg__ph"></div><?php endif; ?>
