...
$eyebrow = ! empty( $theme['eyebrow'] ) ? $theme['eyebrow'] : 'Voyages par thème';
$subtitle = ! empty( $theme['subtitle'] ) ? $theme['subtitle'] : 'Des idées d’évasion pensées pour chaque envie.';
$button_text = ! empty( $theme['button_text'] ) ? $theme['button_text'] : 'VOIR PLUS';
$button_url = ! empty( $theme['button_url'] ) ? $theme['button_url'] : '#';
$title_line_1 = ! empty( $theme['title_line_1'] ) ? $theme['title_line_1'] : 'Explorez';
$title_line_2 = ! empty( $theme['title_line_2'] ) ? $theme['title_line_2'] : 'les voyages';
$title_line_3 = ! empty( $theme['title_line_3'] ) ? $theme['title_line_3'] : 'par thème';
		...
		<div class="aj-theme__grid">
			<aside class="aj-theme__left">
				...
				<div class="aj-theme__left-content">
					...
					<h2 class="aj-theme__title">
						...
						<span><?php echo esc_html( $title_line_2 ); ?></span>
						<span><?php echo esc_html( $title_line_3 ); ?></span>
					</h2>
					<?php if ( $subtitle !== '' ) : ?>
			...
			<div class="aj-theme__right">
				<div class="aj-section-head">
					<h3 class="aj-section-title"><?php echo esc_html__( 'Voyages par thème', 'ajinsafro-traveler-home' ); ?></h3>
					<div class="aj-section-arrows">
						<button type="button" class="aj-section-arrow aj-theme-prev" aria-label="<?php esc_attr_e( 'Précédent', 'ajinsafro-traveler-home' ); ?>"><i class="fas fa-angle-left"></i></button>
