...
ajth_debug_log( 'templates/homepage.php loaded' );
...
ajth_debug_log( 'templates/homepage.php section_order runtime', $section_order );
ajth_debug_log( 'templates/homepage.php sections runtime', $sections );
ajth_debug_log( 'templates/homepage.php holiday_theme runtime', $settings['holiday_theme'] ?? array() );
?>
...
<div class="aj-home-wrap">
    <div id="aj-home" class="aj-home">
        ...
        if ( ajth_debug_enabled() && ! $holiday_theme_rendered && ! empty( $settings['holiday_theme']['enabled'] ) ) {
            ajth_debug_log( 'templates/homepage.php forcing holiday_theme include (debug guard)' );
            include AJTH_DIR . 'parts/holiday-theme.php';
        }
        ?>
    </div>
