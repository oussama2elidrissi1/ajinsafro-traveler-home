        ...
        <section class="aj-voyages-hero aj-voyages-hero--compact">
            <div class="aj-container">
                <div class="aj-voyages-hero__header">
                    <div>
                        <h1 class="aj-voyages-title"><?php esc_html_e('Transfert', 'ajinsafro-traveler-home'); ?></h1>
                        <p class="aj-voyages-subtitle"><?php esc_html_e('Catalogue dynamique des transferts publics alimentes par la base Traveler.', 'ajinsafro-traveler-home'); ?></p>
                    </div>
                </div>
            </div>
        </section>
