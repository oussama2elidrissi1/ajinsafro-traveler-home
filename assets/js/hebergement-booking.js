(function () {
    ...
    var packs = [
        {
            kind: 'pack',
            id: 'pack-marrakech-4j3n',
            title: 'Pack 4 jours / 3 nuits a Marrakech avec petit-dejeuner',
            city: 'Marrakech',
            duration: '4 jours / 3 nuits',
            days: 4,
            nights: 3,
            pension: 'breakfast',
            pensionLabel: 'Petit-dejeuner inclus',
            type: 'hotel',
            typeLabel: 'Hotel boutique',
            price: 1900,
            oldPrice: 2200,
            image: 'https://images.unsplash.com/photo-1597212618440-806262de4f6b?auto=format&fit=crop&w=1200&q=80',
            badges: ['Pack Ajinsafro', 'Petit-dejeuner', 'City Break'],
            includes: ['hebergement', 'breakfast', 'assistance', 'transfer'],
            highlights: ['3 nuits en chambre double', 'Petit-dejeuner quotidien', 'Assistance Ajinsafro 7j/7', 'Transfert aeroport en option'],
            description: 'Une escapade confortable au coeur de Marrakech avec un hotel soigneusement selectionne et un rythme ideal pour un premier sejour.',
            popular: true,
            available: true,
            url: '#pack-marrakech-4j3n'
        },
        {
            kind: 'pack',
            id: 'pack-dakhla-5j4n',
            title: 'Pack 5 jours / 4 nuits a Dakhla avec demi-pension',
            city: 'Dakhla',
            duration: '5 jours / 4 nuits',
            days: 5,
            nights: 4,
            pension: 'half_board',
            pensionLabel: 'Demi-pension',
            type: 'resort',
            typeLabel: 'Resort lagune',
            price: 3980,
            oldPrice: 4390,
            image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80',
            badges: ['Pack Ajinsafro', 'Demi-pension', 'Promo'],
            includes: ['hebergement', 'half_board', 'transfer', 'activity', 'assistance'],
            highlights: ['4 nuits face a la lagune', 'Petit-dejeuner et diner', 'Transferts inclus', 'Activite nautique conseillee'],
            description: 'Un sejour premium a Dakhla pour profiter du lagon, d\'une restauration semi-inclusive et d\'une organisation simple a reserver.',
            popular: true,
            available: true,
            url: '#pack-dakhla-5j4n'
        },
        {
            kind: 'pack',
            id: 'pack-tanger-3j2n',
            title: 'Pack Tanger Weekend 3 jours / 2 nuits avec petit-dejeuner',
            city: 'Tanger',
            ...
            pensionLabel: 'Petit-dejeuner inclus',
            type: 'riad',
            typeLabel: 'Riad / maison d\'hotes',
            price: 1200,
            oldPrice: null,
            image: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&w=1200&q=80',
            badges: ['Pack Ajinsafro', 'Weekend', 'Petit-dejeuner'],
            includes: ['hebergement', 'breakfast', 'assistance'],
            highlights: ['2 nuits en medina ou front de mer', 'Petit-dejeuner inclus', 'Selection week-end Ajinsafro'],
            description: 'Une formule courte et efficace pour un week-end a Tanger avec hebergement bien situe et organisation legere.',
            popular: false,
            available: true,
            url: '#pack-tanger-3j2n'
        },
        {
            kind: 'pack',
            id: 'pack-agadir-famille-4j3n',
            title: 'Pack Agadir Famille 4 jours / 3 nuits avec pension complete',
            city: 'Agadir',
            duration: '4 jours / 3 nuits',
            days: 4,
            nights: 3,
            pension: 'full_board',
            pensionLabel: 'Pension complete',
            type: 'resort',
            typeLabel: 'Resort famille',
            price: 2700,
            oldPrice: 3100,
            image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1200&q=80',
            badges: ['Pack Ajinsafro', 'Famille', 'Pension complete'],
            includes: ['hebergement', 'full_board', 'activity', 'assistance'],
            highlights: ['3 nuits pour 2 adultes et enfants', 'Repas inclus', 'Acces piscine et loisirs', 'Accompagnement Ajinsafro'],
            description: 'Un pack pense pour les familles qui veulent une formule claire, reposante et facile a confirmer rapidement.',
            popular: true,
            available: true,
            url: '#pack-agadir-famille-4j3n'
        }
    ];
